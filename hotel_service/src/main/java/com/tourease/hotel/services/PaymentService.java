...
public class PaymentService {
    ...
    public Payment createPayment(PaymentCreateVO paymentCreateVO, Long workerId) {
        ...
        Payment payment = Payment.builder()
                ...
                .mealPrice(paymentCreateVO.mealPrice().multiply(Currency.getRate(hotel.getCurrency(), paymentCreateVO.currency(), currencyRates)).setScale(2, RoundingMode.HALF_UP))
                .nightPrice(paymentCreateVO.nightPrice().multiply(Currency.getRate(hotel.getCurrency(), paymentCreateVO.currency(), currencyRates)).setScale(2, RoundingMode.HALF_UP))
